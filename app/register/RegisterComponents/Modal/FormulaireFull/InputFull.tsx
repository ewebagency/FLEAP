...
const InputFull: React.FC<InputFullProps> = ({
    ...
    return (
        <div>
            <div className={`w-[400px] overflow-x-auto my-0.5 ${display ? "block" : "hidden"}`}>
                <div className="flex justify-start items-center space-x-2">
                    <div className={`w-[120px] text-right text-xs text-gray-500 ${stylePrimary ? 'font-medium' : 'font-thin'}`}>{titre}</div>
                    {changeLoad ? (
